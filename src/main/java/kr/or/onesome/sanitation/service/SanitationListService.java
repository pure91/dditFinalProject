...
public interface SanitationListService {

    /**
     * 가맹점 자체 위생점검 결과를 등록하기 위한 메서드
    ...
    /**
     * 각 가맹점의 특정 월의 위생점검 내역을 가져오기 위한 메서드
    ...
    /**
     * 현재 선택된 가맹점의 자체 위생점검 목록을 조회하기 위한 메서드
     * @return 위생점검 목록
     */
