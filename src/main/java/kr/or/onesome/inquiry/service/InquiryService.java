package kr.or.onesome.inquiry.service;
...
public interface InquiryService {
    ...
    /**
     * 1:1문의에 가맹점 정보를 선택할 수 있도록 리스트를 가져오기 위한 메서드
    ...
    /**
     * 어드민이 모든 회원의 1:1문의 목록을 조회하기 위한 메서드
     * @return 조회된 문의 내역 리스트
     */
    List<InquiryVO> adminInqList();

    /**
     * 회원의 문의글에 답변을 등록하기 위한 메서드
