...
public interface FranchiseMainService {

    /**
     * 대기중인 주문의 상세정보를 조회하기 위한 메서드
     * @param paramMap 현재 가맹점 번호, 주문번호가 담긴 맵
     * @return 주문의 상세정보
     */
    PaymentVO getOrderDetail(Map<String, Object> paramMap);

    /**
     * 대기중인 메뉴를 준비완료 상태로 변경하기 위한 메서드
    ...
    /**
     * 가맹점의 재고중 적정 재고량보다 부족한 제품들을 조회하기 위한 메서드
     * @param crrFrcsNo 현재 가맹점 번호
     * @return 조회된 제품목록
     */
